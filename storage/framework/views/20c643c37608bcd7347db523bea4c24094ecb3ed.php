    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <form method="POST" action="<?php echo e(route('updatecourse', $course->id)); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input required type="text" class="form-control" name="name"
                                        value="<?php echo e($course->name); ?>" placeholder="Course Name">
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input required type="text" class="form-control" name="code"
                                        value="<?php echo e($course->code); ?>" placeholder="Course Code">
                                </div>
                                    ...
                                    <select class="form-select" name="teacher" required>
                                        ...
                                        <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($teacher->id); ?>"
                                                <?php if($teacher->id == $course->teacher_id): ?> selected <?php endif; ?>><?php echo e($teacher->username); ?>
                                ...
                                <div class="col-md-6 mb-3 form-group">
                                    ...
                                    <input type="date" required class="form-control" name="startDate"
                                        value="<?php echo e($course->start_date); ?>" placeholder="Select Start Date">
                                ...
                                <div class="col-md-6 mb-3 form-group">
                                    ...
                                    <input type="date" required class="form-control" name="endDate"
                                        value="<?php echo e($course->end_date); ?>" placeholder="Select Start Date">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH Z:\ZappFinity\LMS\learnify\resources\views/menu/course_management/edit.blade.php ENDPATH**/ ?>