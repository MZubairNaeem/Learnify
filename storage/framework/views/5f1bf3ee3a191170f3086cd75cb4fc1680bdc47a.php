...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <form method="POST" action="<?php echo e(route('storerole')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group mb-2">
                                <a style="margin-right:3px;" href="<?php echo e(route('viewroles')); ?>" class="btn btn-danger btn-sm">Cancel</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH Z:\ZappFinity\LMS\learnify\resources\views/menu/user_management/roles/add.blade.php ENDPATH**/ ?>