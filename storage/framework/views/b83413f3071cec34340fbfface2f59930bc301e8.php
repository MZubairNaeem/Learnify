                    ...
                    enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 mb-3">
                                ...
                                <div>
                                    <input type="text" value="<?php echo e($role->name); ?>" required class="form-control form-control-icon has-validation" id="roleInput" name="roleInput" placeholder="Enter title">
                                </div>
                            </div>
                            <div class="form-group col-md-6 mb-3">
                                <label for="descriptionInput" class="form-label">Role Description<span style="color: red"> *</span></label>
                                <div>
                                    <input type="text" value="<?php echo e($role->description); ?>" class="form-control form-control-icon" id="descriptionInput" name="descriptionInput" placeholder="Enter Description">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3 form-group">
                                ...
                                <select required class="js-example-basic-multiple" name="role_permissions[]" multiple="multiple"> 
                                    ...
                                    <option <?php if($role->hasPermissionTo($permission->name)): ?> selected <?php endif; ?>><?php echo e($permission->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="col-md-12 form-group mb-2">
                                <a style="margin-right:3px;" href="<?php echo e(url('view-roles')); ?>" class="btn btn-danger btn-sm">Cancel</a>
